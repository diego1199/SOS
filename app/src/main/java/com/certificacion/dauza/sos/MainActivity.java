...
/*
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.MapaTextView) {
           goToMainScreen();
        } else if (id == R.id.historialTextView) {
            goToHistoryScreen();
        } else if (id == R.id.fichaMedicaTextView) {
            goToMedicalRecord();
        } else if (id == R.id.ajustesTextView) {
            goToConfigurations();
        } else if (id == R.id.cerrarSesionTextView){
            logOut();
        }
